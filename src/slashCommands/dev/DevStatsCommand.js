...
class StatsCommand extends BaseCommand {
    ...
    async run(client, message) {
        const ephemeral = message.options.getBoolean('ephemeral') ?? true;
        message.deferReply({ ephemeral: ephemeral });
...
${pingStr}
        ...
        await message.editReply({ embeds: [embed], ephemeral: ephemeral });
    }
}
